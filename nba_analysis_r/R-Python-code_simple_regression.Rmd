...
```{python}
plt.hist(hp1_subset['MP'])
plt.xlabel('Minutes Played With Outliers')
plt.ylabel('Number of Occurrences')
plt.show()

plt.hist(hp1_subset_no['MP'])
plt.show()
```

```{r}
hist(hp1_subset_no$MP)
hist(hp1_working_df$MP)
hist(hp1_working_df$ln_mp)



hist(hp1_subset_no$`2P`)
hist(hp1_working_df$`2P`)
hist(hp1_working_df$ln_2p)

```

```{python}
plt.hist(hp1_working_df['ln_mp'])
plt.xlabel('Natural Log of Minutes Played Without Outliers ')
plt.ylabel('Number of Occurrences')
plt.show()
